  ...
  return (
    <div className="card">
      ...
      <div className="card-body">
        <button className="btn btn-primary" onClick={(e) => postBook(e)}>
          {props.button === "add" ? "Add to Collection" : "Delete from Collection"}
        </button>
        <a href={props.link} class="card-link">Go to Book</a>
      </div>
    </div>
  );
}
